...
const ARTICLES = {
  ...
  "beac-papss-paiements-panafricains": {
    ...
    title: "Paiements panafricains : la BEAC rejoint le PAPSS et arrime l'Afrique centrale au reste du continent",
    excerpt: "La Banque des États de l'Afrique centrale a officiellement adhéré au Système panafricain de paiement et de règlement (PAPSS) le 9 juillet à Yaoundé et au Caire. Le réseau relie désormais 28 pays et plus de 190 banques et fintechs, avec l'ambition de faire circuler l'argent entre marchés africains en quelques secondes, sans passer par le dollar ni l'euro.",
    author: "Rédaction AfriPolitique", date: "11 juillet 2026", read: "5 min",
    body: [
      "<p>C'est une pièce de plus dans un puzzle continental qui se referme lentement. Selon un communiqué diffusé jeudi 9 juillet 2026 depuis Le Caire, la <strong>Banque des États de l'Afrique centrale (BEAC)</strong> a officiellement rejoint le <strong>Système panafricain de paiement et de règlement (PAPSS)</strong>. L'institution, l'une des deux seules banques centrales multinationales du continent, branche ainsi les six pays de la Communauté économique et monétaire de l'Afrique centrale (CEMAC) sur l'infrastructure de paiement instantané la plus ambitieuse jamais conçue par l'Afrique.</p>",
      "<p>Concrètement, la CEMAC — Cameroun, République centrafricaine, Congo, Gabon, Guinée équatoriale et Tchad, soit un marché de plus de <strong>72 millions d'habitants</strong> partageant un franc CFA arrimé à l'euro — fait son entrée dans un réseau qui relie désormais <strong>28 pays africains</strong> et <strong>16 commutateurs nationaux</strong>, connectant plus de <strong>190 banques commerciales et fintechs</strong>. Des accords de partenariat étendent la portée du système à plus de 250 institutions financières supplémentaires à travers le continent.</p>",
      "<h3>Contourner le dollar, réduire les coûts</h3>",
      "<p>Conçu par la banque de financement du commerce Afreximbank, en partenariat avec l'Union africaine et le secrétariat de la Zone de libre-échange continentale africaine (ZLECAf), le PAPSS règle les paiements transfrontaliers directement en monnaies africaines, en quelques secondes. Fini, en théorie, le détour obligé par le dollar ou l'euro et par les coûteuses relations de correspondance bancaire qui renchérissent et ralentissent chaque transaction entre pays voisins.</p>",
      "<p>Cette friction est l'une des explications avancées à la faiblesse persistante du commerce intra-africain, qui plafonne autour de <strong>15 % des échanges du continent</strong>, contre près de 60 % au sein de l'Union européenne. C'est précisément l'écart que la ZLECAf entend combler — et pour lequel une plomberie financière commune est un préalable technique.</p>",
      "<h3>« L'intégration réussira si le secteur financier participe »</h3>",
      "<p>« En rejoignant le PAPSS, la BEAC crée les conditions de paiements transfrontaliers plus rapides, moins chers et plus efficaces entre les pays de la CEMAC et le reste de l'Afrique », a déclaré <strong>Yvon Sana Bangui</strong>, gouverneur de la BEAC et président de l'Association des banques centrales africaines. Le gouverneur a appelé les banques commerciales de la sous-région à se préparer à rejoindre la plateforme, insistant sur un point : l'intégration commerciale du continent ne réussira que si le secteur financier s'y engage activement, et pas seulement par la politique et les infrastructures.</p>",
      "<p>Du côté du PAPSS, le directeur général <strong>Mike Ogbalu III</strong> a salué une « étape importante » vers une intégration financière plus poussée, appelée à ouvrir de nouveaux corridors commerciaux entre l'Afrique centrale et le reste du continent.</p>",
      "<h3>Un pont entre les deux zones franc</h3>",
      "<p>Le calendrier n'a rien d'anodin. L'adhésion de la BEAC intervient alors que le PAPSS s'apprête à lancer, d'ici la fin de l'année, un projet pilote avec la <strong>Banque centrale des États de l'Afrique de l'Ouest (BCEAO)</strong>. Si elle aboutit, cette initiative rapprocherait les deux zones franc CFA — Afrique centrale et Afrique de l'Ouest — au sein d'un même réseau de paiement, une perspective longtemps restée théorique.</p>",
      "<p>Pour les banques et les fintechs, l'adhésion offre un moyen d'étendre leurs services au-delà des frontières nationales sans les frais d'ouverture de comptes de correspondance à l'étranger. Pour les entreprises qui commercent d'un pays de la CEMAC à l'autre, elle promet des règlements plus rapides et des coûts allégés. Pour les particuliers, les transferts et les envois de fonds à l'intérieur de l'Afrique pourraient devenir moins chers et plus rapides que via les opérateurs mondiaux de transfert d'argent.</p>",
      "<h3>Le test de l'exécution</h3>",
      "<p>Reste que la promesse se jouera dans la mise en œuvre. Le commerce de la CEMAC avec le reste de l'Afrique demeure limité : l'essentiel des exportations de pétrole et de matières premières de la région part vers l'Europe et l'Asie, pas vers les marchés voisins. Le modèle de règlement en monnaies locales du PAPSS suppose par ailleurs des marchés de change profonds et liquides, que beaucoup de pays africains sont encore en train de bâtir.</p>",
      "<p>Le PAPSS et la BEAC ont indiqué qu'ils consacreraient le reste de l'année 2026 à opérationnaliser cette adhésion : raccorder les institutions financières de la zone CEMAC, puis déployer les services auprès des entreprises et des particuliers. C'est ce calendrier qui déterminera à quelle vitesse les économies promises parviendront réellement aux 72 millions d'habitants de la sous-région — et si l'Afrique centrale, longtemps en marge des grands chantiers d'intégration, y trouve enfin sa place.</p>"
    ]
  },
