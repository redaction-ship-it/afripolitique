...
const ARTICLES = {
  ...
  "burkina-faso-rupture-diplomatique-france": {
    cat: "cat-diplomatie", catLabel: "Afrique de l'Ouest — Diplomatie & Souveraineté",
    img: "https://images.unsplash.com/photo-1518176258769-f227c798150e?w=1400&q=80&auto=format&fit=crop",
    title: "Ouagadougou rompt avec Paris : la dernière digue franco-burkinabè cède",
    excerpt: "Le Burkina Faso a annoncé le 26 juin 2026 la rupture de ses relations diplomatiques avec la France, accusée d'« ambitions néocoloniales ». Au-delà du symbole, c'est un signal économique et géopolitique majeur pour le Sahel, où Ouagadougou poursuit son basculement vers de nouveaux partenaires.",
    author: "Rédaction AfriPolitique", date: "29 juin 2026", read: "5 min",
    body: [
      "<p>La rupture était redoutée depuis des mois ; elle est désormais consommée. Le <strong>26 juin 2026</strong>, le gouvernement burkinabè a annoncé la rupture de ses relations diplomatiques avec la France, « avec effet immédiat ». Dans un communiqué au ton sans équivoque, la junte dirigée par le capitaine <strong>Ibrahim Traoré</strong> — au pouvoir depuis le coup d'État de septembre 2022 — reproche à Paris des « ambitions néocoloniales » et un « soutien actif aux réseaux subversifs et aux terroristes qui endeuillent notre pays et le Sahel ».</p>",
      "<p>Ouagadougou prend soin de circonscrire la portée du geste : la décision « vise exclusivement le cadre institutionnel des relations entre les deux États sur le plan diplomatique » et « ne remet nullement en cause les liens historiques, humains, culturels et sociaux qui unissent les peuples burkinabè et français ». Une formule diplomatique destinée à protéger la diaspora et les échanges entre sociétés civiles, alors même que le canal officiel entre les deux capitales se referme.</p>",
      "<h3>Paris dénonce une « décision hostile et infondée »</h3>",
      "<p>La réaction française n'a pas tardé. Le Quai d'Orsay a regretté une « décision hostile et infondée, qui illustre la dérive inquiétante des autorités burkinabè », tout en annonçant examiner des « mesures réciproques ». Paris a par ailleurs appelé ses ressortissants présents au Burkina Faso à « la plus grande vigilance ». Les deux pays s'acheminent ainsi vers un face-à-face où chaque mesure de rétorsion pourrait en appeler une autre, sur fond de contentieux accumulés depuis quatre ans.</p>",
      "<p>Car la rupture du 26 juin n'est pas un coup de tonnerre dans un ciel serein : elle parachève une dégradation entamée dès l'arrivée au pouvoir de la junte. Retrait des forces françaises après 2022, expulsions de diplomates, suspension de médias français, fin des accords de coopération militaire : le fil s'était distendu jusqu'à ne plus tenir qu'à un dernier point d'attache, désormais tranché.</p>",
      "<h3>Un coût économique réel, mais contenu</h3>",
      "<p>Sur le strict plan commercial, la France n'occupe plus une place centrale dans l'économie burkinabè. Selon la Direction générale du Trésor, le Burkina Faso n'est que le <strong>104ᵉ partenaire commercial</strong> de la France, et le stock d'investissements français dans le pays s'établissait à <strong>510 millions d'euros en 2024</strong>, en hausse de 49 % par rapport à 2020. Des montants qui restent modestes au regard d'autres marchés africains, mais qui concernent des secteurs sensibles : mines, énergie, infrastructures, services.</p>",
      "<p>L'or constitue le véritable nerf de la guerre. Quatrième producteur du continent, le Burkina Faso tire de son secteur minier près de <strong>20 % des recettes de l'État</strong>, avec des gisements de manganèse de rang mondial et des réserves de nickel, de phosphate ou de graphite. En reprenant le contrôle de cette rente — nationalisations partielles, création d'une compagnie minière d'État, révision du code minier — la junte cherche à financer son effort de guerre tout en réduisant sa dépendance aux capitaux occidentaux.</p>",
      "<h3>Le pari du basculement vers de nouveaux partenaires</h3>",
      "<p>La rupture avec Paris s'inscrit dans une recomposition plus large. Le Burkina Faso, membre fondateur avec le Mali et le Niger de la <strong>Confédération des États du Sahel (AES)</strong>, mise sur l'intégration régionale et sur de nouveaux alliés — au premier rang desquels la Russie — pour combler le vide laissé par le désengagement français. L'AES, qui a acté son retrait de la CEDEAO, travaille à une zone économique intégrée, une foire commerciale commune et des projets d'infrastructures partagés, malgré la faiblesse persistante des échanges intra-régionaux.</p>",
      "<p>Reste que ce repositionnement comporte des risques. La sécurité demeure le talon d'Achille du pays : les groupes jihadistes contrôlent toujours de vastes portions du territoire, et la reprise de croissance attendue en 2026, portée par l'or et l'agriculture, reste suspendue aux conditions météorologiques et à la stabilité du front. Couper les ponts avec un partenaire historique, c'est aussi se priver de canaux de financement, de coopération technique et d'accès à certains marchés européens.</p>",
      "<h3>Un signal pour tout le Sahel</h3>",
      "<p>Au-delà du cas burkinabè, la décision résonne comme un marqueur de l'époque. Après les tensions maliennes et nigériennes, c'est désormais l'ensemble du « pré carré » sahélien qui échappe à l'influence diplomatique française. Pour Paris, la question n'est plus de savoir comment préserver une relation privilégiée, mais comment redéfinir une présence devenue indésirable. Pour Ouagadougou, le pari est clair : transformer la rupture symbolique en levier de souveraineté économique. L'équation, elle, reste à résoudre — entre l'ambition affichée et les contraintes d'un pays enclavé, en guerre, et dépendant de quelques produits d'exportation.</p>",
      "<p>Les prochaines semaines diront si la « mesure réciproque » française se limitera à un geste symétrique ou si elle s'étendra au terrain économique, là où les deux pays ont encore des intérêts croisés. Une chose est sûre : la page d'une relation vieille de plus d'un siècle vient d'être tournée, et le Sahel de 2026 s'écrit désormais sans Paris.</p>"
    ]
  },

  "dakar-souverainete-ia-2026": {
    ...
    title: "Souveraineté numérique : Dakar veut devenir la capitale africaine de l'intelligence artificielle",
    excerpt: "En réunissant plus de 500 startups venues de trois continents, le Sommet de l'IA de Dakar a affiché l'ambition sénégalaise de peser dans la course mondiale à l'intelligence artificielle. Derrière l'événement, une bataille politique et financière : qui contrôlera les données, les centres de calcul et la valeur d'une technologie qui pourrait ajouter 1 000 milliards de dollars au PIB du continent d'ici 2035 ?",
    author: "Rédaction AfriPolitique", date: "25 juin 2026", read: "5 min",
    body: [
      "<p>Pendant deux jours, les 18 et 19 juin, Dakar s'est transformée en vitrine de l'ambition technologique africaine. Le <strong>K-Sénégal AI Startup Summit 2026</strong> a réuni, selon ses organisateurs, plus de <strong>500 startups</strong> issues de trois continents, des décideurs publics et des investisseurs internationaux. Au-delà des pitchs et des panels, l'événement a cristallisé une question devenue centrale pour les capitales africaines : comment ne pas rester spectateur d'une révolution technologique appelée à redessiner l'économie mondiale.</p>",
      "<h3>Un marché en pleine accélération</h3>",
      "<p>Les chiffres expliquent l'empressement. Le marché africain de l'intelligence artificielle devrait croître d'environ <strong>27 % par an d'ici 2030</strong> pour atteindre <strong>16,5 milliards de dollars</strong>, selon une étude de Mastercard. À plus long terme, la Banque africaine de développement estime qu'un déploiement inclusif de l'IA pourrait générer jusqu'à <strong>1 000 milliards de dollars de PIB supplémentaire d'ici 2035</strong> — soit près d'un tiers de la production économique actuelle du continent. Pour des États confrontés à un déficit de financement du développement supérieur à 1 300 milliards de dollars par an, la promesse d'un gain de productivité de cette ampleur a valeur de planche de salut.</p>",
      "<p>Le Sénégal entend en capter sa part. Dans le cadre d'un partenariat avec la Corée du Sud, le futur Centre de transformation par l'intelligence artificielle (CTIA), prévu à Diamniadio, représente un investissement d'environ <strong>8,23 milliards de FCFA</strong> (quelque 14,5 millions de dollars) étalé entre 2026 et 2033. Une somme modeste à l'échelle des géants du secteur, mais un signal politique clair : faire de Dakar un point d'ancrage régional de la filière.</p>",
      "<h3>Le nœud de la souveraineté</h3>",
      "<p>Derrière l'enthousiasme, un constat dérange. L'Afrique ne pèse aujourd'hui qu'environ <strong>1 % des données utilisées pour entraîner les modèles d'intelligence artificielle</strong>, selon plusieurs travaux dont ceux de la Banque de France. Autrement dit, les systèmes qui structureront demain l'accès au crédit, à la santé ou à l'éducation sur le continent sont massivement conçus ailleurs, avec des données venues d'ailleurs. La question de la <strong>souveraineté numérique</strong> — le contrôle des données, des infrastructures de calcul et de la régulation — s'est imposée comme le fil rouge des débats de Dakar.</p>",
      "<p>Cette souveraineté se joue d'abord dans les centres de données. Le marché africain des data centers devrait atteindre <strong>8,76 milliards de dollars d'investissements d'ici 2031</strong>, avec une croissance annuelle de près de 16 %, selon le cabinet Arizton. Les opérateurs se positionnent : Cassava Technologies, adossé à un accord de 700 millions de dollars avec Nvidia, déploie des « usines à IA » équipées de plusieurs milliers de processeurs graphiques en Afrique du Sud, avant l'Égypte, le Nigeria, le Kenya et le Maroc — avec l'argument explicite de <em>maintenir les données africaines sur le sol africain</em>.</p>",
      "<h3>Une fracture qui pourrait se creuser</h3>",
      "<p>Reste un risque : que la révolution profite à quelques-uns. En 2025, environ <strong>72 % des financements des startups technologiques africaines</strong> se sont concentrés sur le « big four » — Afrique du Sud, Égypte, Kenya et Nigeria — laissant le reste du continent à la marge. Pour des pays comme le Sénégal, l'enjeu est aussi d'éviter de devenir un simple marché de consommation d'outils conçus hors de ses frontières.</p>",
      "<p>C'est pourquoi la dimension politique de la course à l'IA monte en puissance. Sur le continent, 44 pays se sont dotés de lois sur la protection des données et 38 ont établi des autorités de contrôle, signe d'une volonté de cadrer l'usage de la technologie. Le Sénégal, qui multiplie les rendez-vous internationaux sur la gouvernance de l'IA, cherche à transformer cet activisme diplomatique en influence réelle dans les enceintes où se définissent les règles mondiales.</p>",
      "<p>Le pari dakarois résume celui de tout un continent : convertir un potentiel démographique et un appétit numérique en capacités souveraines, sans reproduire les dépendances du passé. Entre l'effervescence des startups et la réalité des infrastructures, l'écart reste considérable. Mais en réunissant investisseurs, fondateurs et États autour d'une même table, Dakar a envoyé un message : l'Afrique entend négocier sa place dans l'économie de l'intelligence artificielle, pas la subir.</p>"
    ]
  },
