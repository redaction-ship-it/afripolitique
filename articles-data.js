...
const ARTICLES = {
  ...
  "dangote-engrais-afc-souverainete-alimentaire": {
    cat: "cat-economie", catLabel: "Afrique \u2014 \u00c9conomie & Industrie",
    img: "https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=1400&q=80&auto=format&fit=crop",
    title: "Engrais : 600 millions de dollars pour Dangote, l'Afrique joue sa souverainet\u00e9 alimentaire",
    excerpt: "L'Africa Finance Corporation engage 600 millions de dollars dans un programme de 7 milliards port\u00e9 par le groupe Dangote pour tripler la production d'engrais du continent. Objectif politique autant qu'industriel : rompre avec une d\u00e9pendance aux importations qui frôle les 90 %.",
    author: "R\u00e9daction AfriPolitique", date: "24 juin 2026", read: "5 min",
    body: [
      "<p>C'est l'un des plus gros engagements financiers jamais consentis \u00e0 l'industrie de l'engrais sur le continent. L'<strong>Africa Finance Corporation</strong> (AFC), institution multilat\u00e9rale panafricaine bas\u00e9e \u00e0 Lagos, a annonc\u00e9 \u00e0 la mi-juin un pr\u00eat de <strong>600 millions de dollars</strong> \u00e0 GreenView Fertilizer Corp., la holding engrais du groupe d'Aliko Dangote. Cette facilit\u00e9 constitue la pierre angulaire d'un programme d'expansion \u00e9valu\u00e9 \u00e0 <strong>7 milliards de dollars</strong>, destin\u00e9 \u00e0 faire de l'Afrique un producteur \u2014 et un exportateur \u2014 net d'engrais.</p>",
      "<p>L'op\u00e9ration est d'abord industrielle. Elle vise \u00e0 porter la capacit\u00e9 de production d'ur\u00e9e du complexe Dangote, situ\u00e9 \u00e0 Ibeju-Lekki dans l'\u00c9tat de Lagos, de <strong>3 \u00e0 9 millions de tonnes par an</strong>, soit un triplement. Un second volet pr\u00e9voit la construction d'une nouvelle usine de <strong>3 millions de tonnes en \u00c9thiopie</strong>, donnant au conglom\u00e9rat nig\u00e9rian une seconde base de production en Afrique de l'Est. \u00c0 terme, le groupe veut s'imposer parmi les premiers fabricants mondiaux d'engrais azot\u00e9s.</p>",
      "<h3>Une d\u00e9pendance qui pèse sur la s\u00e9curit\u00e9 alimentaire</h3>",
      "<p>Derri\u00e8re les chiffres, un enjeu politique de premier plan. L'Afrique importe aujourd'hui <strong>plus de 90 % de ses besoins en engrais</strong>, alors qu'elle dispose de la terre, de la main-d'\u0153uvre et, dans le cas du Nig\u00e9ria, du gaz n\u00e9cessaire pour les produire. Cette d\u00e9pendance expose le continent aux chocs de prix mondiaux : la flamb\u00e9e des cours en 2022, dans le sillage de la guerre en Ukraine, avait amput\u00e9 les rendements agricoles de millions de petits exploitants incapables de s'approvisionner.</p>",
      "<p>Pour l'AFC, financer l'engrais revient donc \u00e0 financer la souverainet\u00e9 alimentaire. \u00ab\u00a0Il s'agit de lib\u00e9rer l'Afrique de sa d\u00e9pendance\u00a0\u00bb, r\u00e9sume en substance l'institution, qui pr\u00e9sente l'investissement comme un levier pour stabiliser les prix domestiques, soutenir la production vivri\u00e8re et r\u00e9duire la facture des importations en devises \u2014 un poste qui pèse lourd sur des balances des paiements d\u00e9j\u00e0 fragilis\u00e9es par le service de la dette.</p>",
      "<h3>Quatre milliards de dollars de recettes esp\u00e9r\u00e9es</h3>",
      "<p>L'argument \u00e9conomique est tout aussi central. Aliko Dangote affirme que l'expansion pourrait g\u00e9n\u00e9rer <strong>plus de 4 milliards de dollars de recettes d'exportation par an</strong> pour le Nig\u00e9ria dans un d\u00e9lai de trois ans, transformant un pays longtemps d\u00e9pendant de ses seules ventes de p\u00e9trole brut en exportateur de produits manufactur\u00e9s \u00e0 plus forte valeur ajout\u00e9e. Pour Abuja, c'est l'illustration concr\u00e8te de la diversification \u00e9conomique pr\u00f4n\u00e9e depuis des ann\u00e9es mais rarement mat\u00e9rialis\u00e9e \u00e0 cette \u00e9chelle.</p>",
      "<p>Le montage financier porte aussi une charge symbolique. C'est une institution africaine \u2014 l'AFC, dont les actionnaires sont en majorit\u00e9 des \u00c9tats et des banques du continent \u2014 qui finance l'industrialisation africaine, dans un contexte o\u00f9 la part des investisseurs europ\u00e9ens dans les lev\u00e9es de fonds du continent s'est nettement contract\u00e9e ces deux derni\u00e8res ann\u00e9es au profit du capital local. La logique panafricaine, longtemps cantonn\u00e9e aux discours des sommets, prend ici une traduction industrielle.</p>",
      "<h3>Des r\u00e9serves \u00e0 ne pas occulter</h3>",
      "<p>L'enthousiasme appelle toutefois quelques nuances. La strat\u00e9gie mise une part consid\u00e9rable de la s\u00e9curit\u00e9 alimentaire continentale sur un seul conglom\u00e9rat, d\u00e9j\u00e0 dominant dans le ciment et le raffinage : cette concentration interroge sur la concurrence et la r\u00e9silience du dispositif. La production d'ur\u00e9e reste par ailleurs adoss\u00e9e au gaz naturel, une ressource dont les cours et la disponibilit\u00e9 conditionneront la comp\u00e9titivit\u00e9 des usines. Enfin, produire l'engrais ne suffit pas : encore faut-il qu'il parvienne, \u00e0 un prix abordable, jusqu'aux exploitations enclav\u00e9es du Sahel ou des Grands Lacs, ce qui suppose des r\u00e9seaux logistiques et de distribution aujourd'hui d\u00e9faillants.</p>",
      "<p>Reste que l'annonce marque un tournant. En conjuguant capital africain, ambition continentale et logique de souverainet\u00e9, le programme Dangote-AFC s'inscrit dans une s\u00e9quence o\u00f9 l'Afrique cherche \u00e0 transformer sur place ses ressources plut\u00f4t qu'\u00e0 les exporter brutes. De l'engrais aux centres de donn\u00e9es, le m\u00eame fil rouge se dessine : produire ce que le continent consomme, et cesser de d\u00e9pendre de cha\u00eenes d'approvisionnement qu'il ne ma\u00eetrise pas. Le pari, cette fois, se chiffre en milliards \u2014 et en tonnes.</p>"
    ]
  },
