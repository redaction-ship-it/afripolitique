...
const ARTICLES = {
  ...
  "afrique-data-centers-souverainete-ia": {
    ...
    title: "Data centers : l'Afrique entre dans la course à l'IA, mais ne pèse encore que 0,6 % des capacités mondiales",
    excerpt: "Le plus grand rendez-vous du secteur ouvre ce 23 juin à Johannesburg, sur fond de ruée des géants du cloud. Derrière les milliards annoncés se joue une bataille politique : celle de la souveraineté numérique d'un continent qui produit ses données mais héberge à peine 0,6 % des capacités mondiales de calcul.",
    author: "Rédaction AfriPolitique", date: "23 juin 2026", read: "5 min",
    body: [
      "<p>C'est à Sandton, le quartier d'affaires de Johannesburg, que se tient à partir de ce mardi 23 juin la <strong>Pan African DataCentres Exhibition & Conference</strong>, principal rendez-vous du secteur sur le continent. Pendant deux jours, opérateurs, fournisseurs d'énergie et hyperscalers — Microsoft livre le discours d'ouverture, Google participe au programme — débattent d'une même question : comment l'intelligence artificielle redessine la carte des infrastructures numériques africaines. Le thème résume une tension que les organisateurs ne cachent pas : l'IA arrive en Afrique avant que les infrastructures ne soient prêtes à l'accueillir.</p>",
      "<p>Le paradoxe est saisissant. Le continent abrite plus de 18 % de la population mondiale, mais ne concentre qu'environ <strong>0,6 % des capacités mondiales de data centers</strong>. Le marché africain reste modeste — estimé à quelque <strong>2,22 milliards de dollars en 2026</strong>, avec une projection à 4,36 milliards d'ici 2031 (croissance annuelle de l'ordre de 14,5 %, selon Mordor Intelligence). En puissance installée, l'Afrique dispose d'environ 360 mégawatts (MW) de capacité active, 238 MW en construction et 656 MW planifiés. À l'échelle des chantiers ouverts dans le Golfe ou en Asie, c'est une goutte d'eau.</p>",
      "<h3>Une géographie très concentrée</h3>",
      "<p>Cette capacité reste de surcroît très inégalement répartie. L'Afrique du Sud, le Kenya et le Nigeria réunissent à eux seuls environ <strong>41 % des centres de données du continent</strong> : 56 installations pour l'Afrique du Sud, 19 pour le Kenya, 17 pour le Nigeria, selon les données relayées par l'African Energy Chamber. Premier hub africain, l'Afrique du Sud pèse à elle seule un marché d'environ 0,67 milliard de dollars en 2026 et concentre la grande majorité des capacités engagées. Le reste du continent, lui, dépend encore largement de serveurs hébergés en Europe.</p>",
      "<p>Or ce modèle devient intenable. La montée des exigences de latence — la vitesse à laquelle une donnée fait l'aller-retour — et le durcissement des réglementations sur la <strong>souveraineté des données</strong> poussent plusieurs États à imposer que certaines informations sensibles restent stockées sur le sol national. Pour les géants du cloud, cela signifie une seule chose : il faut construire en Afrique, au plus près des utilisateurs.</p>",
      "<h3>La ruée des capitaux</h3>",
      "<p>Le mouvement est déjà engagé. Microsoft a annoncé ce printemps un investissement supplémentaire de <strong>329 millions de dollars</strong> en Afrique du Sud, qui s'ajoute à une enveloppe antérieure de 1,2 milliard, pour acheter du foncier, sécuriser l'approvisionnement en énergie et en eau et étendre ses centres existants. Au Kenya, un data center « vert » de 100 MW est prévu dans la zone géothermique de Naivasha, porté par un milliard de dollars d'engagements de Microsoft et de l'émiratie G42. Au Nigeria, Equinix élargit son site de Lagos. Sur l'ensemble de la région Moyen-Orient–Afrique, les engagements liés à l'IA et aux centres de données dépassent désormais les 100 milliards de dollars.</p>",
      "<p>Le moteur de cette frénésie porte un nom : l'intelligence artificielle. Le cabinet McKinsey estime que l'entraînement et l'exploitation des modèles d'IA pourraient <strong>tripler la demande mondiale</strong> de capacité de calcul d'ici 2030, 70 % de la nouvelle demande étant liée à ces usages. L'Afrique suit la même pente : sa puissance informatique installée devrait elle aussi tripler pour atteindre environ <strong>1,2 gigawatt</strong> à l'horizon 2030.</p>",
      "<h3>L'énergie, le verrou décisif</h3>",
      "<p>Reste l'obstacle le plus politique de tous : l'électricité. Un data center est un gouffre énergétique, et nombre de réseaux africains peinent déjà à alimenter les ménages et l'industrie. L'Association des acteurs africains des data centers chiffre à au moins <strong>1 000 MW de capacité nouvelle, répartis sur quelque 700 installations</strong>, le besoin pour répondre à la demande. Mais ce défi est aussi une opportunité : pour plusieurs experts du secteur énergétique, la demande garantie et solvable des data centers pourrait devenir le déclencheur d'investissements massifs dans les énergies renouvelables — solaire, éolien, géothermie — dont le continent a cruellement besoin.</p>",
      "<p>Derrière les chiffres se profile donc un choix de société. Soit l'Afrique se contente d'être un marché de consommation pour des infrastructures détenues et pilotées depuis l'étranger ; soit elle bâtit, sur son sol et avec sa propre énergie, la colonne vertébrale de son économie de la donnée. Le rendez-vous de Johannesburg, qui réunit cette année États, opérateurs et bailleurs, dira si le discours sur la souveraineté numérique se traduit enfin en mégawatts et en serveurs installés — ou s'il reste, pour la décennie qui s'ouvre, une promesse de plus.</p>"
    ]
  },
