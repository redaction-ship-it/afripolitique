...
const ARTICLES = {
  ...
  "tech-afrique-financement-ia-2026": {
    ...
    title: "Tech africaine : à neuf jours de la clôture du semestre, le financement file vers 1,3 milliard malgré le siphon de l'IA américaine",
    excerpt: "Au 3 juin, les start-up africaines avaient déjà levé 1,3 milliard de dollars, portées par le méga-tour de 215 millions de Spiro. Mais derrière la course aux records se joue une bascule plus profonde : aspiré par le boom de l'IA aux États-Unis, le capital mondial se raréfie, et l'Afrique apprend à se financer chez elle.",
    author: "Rédaction AfriPolitique", date: "21 juin 2026", read: "5 min",
    body: [
      "<p>À neuf jours de la clôture du premier semestre, l'écosystème technologique africain joue une fin de course haletante. Au mercredi 3 juin, les jeunes pousses du continent avaient déjà mobilisé <strong>1,3 milliard de dollars</strong> depuis janvier, selon le décompte de TC Insights, la cellule de recherche de TechCabal. Un rythme qui défie la morosité de l'économie mondiale et signale que les investisseurs gardent un appétit solide pour l'innovation africaine.</p>",
      "<p>Le chiffre tient en grande partie à un seul nom. Le 1er juin, <strong>Spiro</strong>, spécialiste panafricain de la mobilité électrique et de l'échange de batteries, a bouclé un tour de table de <strong>215 millions de dollars</strong>, l'un des plus gros de l'année. L'opération, confirmée par Bloomberg et la presse spécialisée, rapproche l'entreprise du statut convoité de licorne (un milliard de dollars de valorisation) et doit financer son déploiement industriel et son entrée sur de nouveaux marchés à forte croissance.</p>",
      "<h3>Une course aux records sur le fil</h3>",
      "<p>La comparaison avec 2025 est serrée. Sur la période janvier-mai, le continent avait capté 1,056 milliard de dollars l'an dernier ; il en est cette année à 1,044 milliard sur le même intervalle. L'injection de Spiro propulse le total 2026 à 1,3 milliard. Or, l'ensemble du premier semestre 2025 avait atteint <strong>1,42 milliard de dollars</strong> : à fin mai, il ne manquait donc qu'environ <strong>121 millions</strong> pour battre le record du semestre précédent. Le verdict tombera le 30 juin.</p>",
      "<p>Le mois de mai a, lui, ajouté 124 millions de dollars, dominé par la fintech et la logistique : 50 millions de crédit pour le tanzanien Nala (paiements transfrontaliers en stablecoins), une extension de tour de 34,8 millions pour LemFi (services financiers aux migrants) et 8 millions de dette pour MAX, dans la mobilité électrique. Au-delà des levées, TC Insights recense plus de 50 opérations de fusions-acquisitions depuis le début de l'année, pour plus de 100 millions de dollars cumulés — signe d'un marché qui se consolide.</p>",
      "<h3>Le grand siphon de l'intelligence artificielle</h3>",
      "<p>Derrière ces records se cache un mouvement de fond plus inquiétant pour le continent. La ruée mondiale vers l'intelligence artificielle aspire le capital-risque vers les États-Unis : selon les données citées par Bloomberg, l'investissement de capital-risque lié à l'IA a doublé l'an dernier pour atteindre <strong>259 milliards de dollars</strong>, dont près des <strong>trois quarts</strong> ont irrigué des entreprises américaines. Pour les marchés émergents, la conséquence est mécanique : il faut se battre plus dur pour des financements devenus plus rares, surtout sur les tours de série B et au-delà.</p>",
      "<p>La réponse africaine est un repli stratégique vers le capital domestique. Une enquête de Bloomberg auprès de 25 start-up à suivre sur le continent montre que les bailleurs <strong>locaux</strong> — institutions de financement du développement, fonds de pension, prêteurs et fonds de capital-risque africains — représentent désormais <strong>47 %</strong> des engagements, contre moins d'un quart pour les financeurs américains. En 2025, les start-up africaines avaient déjà presque doublé leur recours à la dette, alors même que les apports en fonds propres reculaient.</p>",
      "<h3>Une question de souveraineté financière</h3>",
      "<p>Cette bascule dépasse la seule sphère des entrepreneurs : elle pose la question de la souveraineté financière du continent. Le financement reste hyper-concentré — le « Big Four » (Afrique du Sud, Égypte, Kenya, Nigeria) capte encore environ <strong>82 %</strong> des montants levés, selon le bilan annuel de The Big Deal, qui chiffrait à 3,2 milliards de dollars (+40 %) le rebond de 2025. Les responsables financiers du continent plaident pour mobiliser les quelque 250 milliards de dollars d'actifs logés dans les institutions africaines de financement du développement, tandis que l'idée d'un fonds panafricain dédié à l'IA fait son chemin dans les discours.</p>",
      "<p>L'enjeu est aussi politique. Bâtir une couche locale de capital-risque crédible, c'est réduire la dépendance aux humeurs des investisseurs étrangers et garder sur place la valeur créée par les talents africains. Mais l'exercice a ses limites : sans chefs de file internationaux prêts à assumer le risque régional, les tours de financement les plus avancés restent difficiles à boucler.</p>",
      "<h3>Le revers : des outils plus puissants, moins d'emplois</h3>",
      "<p>Reste l'éléphant dans la pièce. L'IA, désormais au cœur du fonctionnement de la tech africaine — TC Insights recense plus de 100 cas d'usage, du scoring de crédit à la détection de fraude —, est aussi devenue un facteur de destruction d'emplois. Le cabinet a comptabilisé <strong>plus de 1 000 licenciements</strong> sur le continent depuis le début de 2026, contre 698 sur la même période en 2025. Et les entreprises citent désormais explicitement l'automatisation : Jumia a supprimé 200 postes en intégrant l'IA à sa logistique, Zap Africa a réduit ses effectifs de 44 % au terme d'une restructuration pilotée par l'IA.</p>",
      "<p>À la veille du 30 juin, le continent attend donc deux verdicts qui n'en font qu'un. Le premier, comptable : le record du semestre sera-t-il battu ? Le second, stratégique : l'Afrique parviendra-t-elle à transformer ce sursaut de financement en un écosystème durable, capable de se financer lui-même et de créer plus d'emplois qu'il n'en automatise. La réponse dira si la tech africaine est en train de gagner sa course — ou seulement de courir plus vite pour rester sur place.</p>"
    ]
  },
