...
const ARTICLES = {
  ...
  "afrique-fdi-70-milliards-2026": {
    cat: "cat-economie", catLabel: "Afrique — Économie & Finance",
    img: "https://images.unsplash.com/photo-1601597111158-2fceff292cdc?w=1400&q=80&auto=format&fit=crop",
    title: "Investissements étrangers : l'Afrique capte 70 milliards de dollars, le Nigeria revient dans le top 5",
    excerpt: "Selon le Rapport 2026 de la CNUCED sur l'investissement, l'Afrique a attiré environ 70 milliards de dollars d'investissements directs étrangers en 2025 — son troisième meilleur niveau depuis 1990. Le Nigeria réintègre le top 5 avec des entrées qui doublent à 4,01 milliards, mais l'essentiel des capitaux reste concentré sur les matières premières.",
    author: "Rédaction AfriPolitique", date: "10 juillet 2026", read: "5 min",
    body: [
      "<p>C'est un signal que les chancelleries économiques du continent scrutaient. Selon le <em>Rapport sur l'investissement dans le monde 2026</em> publié par la CNUCED (Conférence des Nations unies sur le commerce et le développement), l'Afrique a capté environ <strong>70 milliards de dollars</strong> d'investissements directs étrangers (IDE) en 2025. Le chiffre marque un recul par rapport au niveau exceptionnel de 2024, mais il demeure le <strong>troisième plus élevé depuis 1990</strong> et se situe environ un tiers au-dessus de la moyenne de long terme du continent.</p>",
      "<p>Le repli est en trompe-l'œil. L'année 2024 avait été gonflée par une opération hors norme, le mégaprojet immobilier et touristique de Ras El-Hekma en Égypte, financé par les Émirats arabes unis. Une fois cet effet ponctuel neutralisé, la performance sous-jacente de 2025 témoigne d'un appétit soutenu des investisseurs pour les actifs africains, dans un contexte mondial pourtant marqué par la fragmentation commerciale et les tensions géopolitiques.</p>",
      "<h3>Le Nigeria de retour dans le peloton de tête</h3>",
      "<p>La nouvelle la plus commentée est le retour du Nigeria parmi les cinq premières destinations d'IDE du continent. Les entrées de capitaux dans la première économie ouest-africaine ont plus que doublé, bondissant de <strong>148 %</strong> pour atteindre <strong>4,01 milliards de dollars</strong>, contre 1,61 milliard un an plus tôt. Il s'agit du meilleur niveau enregistré par Abuja depuis 2014. La CNUCED attribue ce rebond en grande partie à des financements de projets liés au pétrole et au gaz, dont une opération évaluée à environ 2 milliards de dollars.</p>",
      "<p>Deux transactions emblématiques illustrent ce mouvement : la cession par Shell de ses actifs pétroliers terrestres au consortium nigérian Renaissance Africa Energy, et le rachat de Lafarge Africa par le cimentier chinois Huaxin Cement. Autant d'opérations qui traduisent une recomposition du capital dans les secteurs stratégiques, entre désengagement des majors occidentales et montée en puissance d'acteurs locaux et asiatiques.</p>",
      "<h3>Un podium dominé par les ressources naturelles</h3>",
      "<p>Le classement continental confirme la prééminence de quelques économies. L'<strong>Égypte</strong> conserve sa place de première destination africaine, avec environ 15,5 milliards de dollars d'entrées, malgré un net repli après l'exercice 2024. La <strong>Guinée</strong> réalise la plus forte progression du continent : ses IDE s'envolent de plus de <strong>450 %</strong>, à 7,76 milliards de dollars, portés par les investissements dans la bauxite et le minerai de fer — au premier rang desquels le géant Simandou. Le <strong>Mozambique</strong> complète le podium avec 5,69 milliards, grâce à la relance des grands projets de gaz naturel liquéfié. Le Nigeria se classe quatrième.</p>",
      "<p>Cette géographie de l'investissement raconte une histoire ambivalente. Les capitaux affluent, mais ils se dirigent massivement vers les industries extractives : hydrocarbures, bauxite, fer, gaz. Le schéma reste largement celui d'une Afrique pourvoyeuse de matières premières, davantage que celle d'un continent industrialisant sa chaîne de valeur. La question de la transformation locale — raffiner, usiner, fabriquer sur place plutôt qu'exporter des ressources brutes — demeure le grand impensé de ce cycle d'investissement.</p>",
      "<h3>La diplomatie économique en toile de fond</h3>",
      "<p>Derrière les chiffres se joue aussi une bataille d'influence. Les États-Unis ont fait de l'investissement privé un instrument de « diplomatie commerciale », présenté comme un contrepoids aux initiatives chinoises des Nouvelles routes de la soie. La Chine, de son côté, continue de racheter des actifs industriels et miniers, tandis que les monarchies du Golfe multiplient les prises de participation. Pour les gouvernements africains, l'enjeu n'est plus seulement d'attirer les capitaux, mais de choisir leurs partenaires et de négocier des contreparties en matière d'emplois, de transfert de technologie et de recettes fiscales.</p>",
      "<p>Le rapport de la CNUCED souligne enfin une fragilité structurelle : la forte concentration des flux sur un petit nombre de pays et de secteurs. Une poignée d'économies capte l'essentiel des IDE, quand des dizaines d'autres restent à la marge des grands circuits financiers. Pour que les 70 milliards de dollars de 2025 se traduisent en croissance inclusive, l'Afrique devra élargir la base de ses destinations attractives et orienter l'investissement vers les infrastructures, l'énergie et le numérique — secteurs où les besoins se chiffrent en centaines de milliards.</p>",
      "<p>En attendant, le millésime 2025 confirme une certitude : malgré les turbulences mondiales, l'Afrique reste dans le radar des investisseurs. Reste à transformer cette attractivité en souveraineté économique.</p>"
    ]
  },
