...
const ARTICLES = {
  ...
  "vodacom-safaricom-controle": {
    cat: "cat-economie", catLabel: "Afrique — Économie & Tech",
    img: "https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=1400&q=80&auto=format&fit=crop",
    title: "Kenya : Vodacom prend le contrôle de Safaricom, une privatisation à 2 milliards de dollars qui divise",
    excerpt: "Le groupe sud-africain Vodacom détient désormais 55 % de Safaricom, joyau des télécoms est-africains et maison mère de M-Pesa, après le rachat de la participation de l'État kényan pour environ 2,1 milliards de dollars. Nairobi empoche près de 244,5 milliards de shillings pour financer ses infrastructures, mais l'opposition dénonce la vente d'un actif stratégique.",
    author: "Rédaction AfriPolitique", date: "6 juillet 2026", read: "5 min",
    body: [
      "<p>C'est l'une des plus importantes transactions télécoms jamais réalisées sur le continent. Le sud-africain <strong>Vodacom</strong> a finalisé l'acquisition de la participation de 15 % que détenait l'État kényan dans <strong>Safaricom</strong>, portant sa part de 35 % à <strong>55 %</strong> et prenant ainsi le contrôle majoritaire du premier opérateur d'Afrique de l'Est. L'opération, bouclée quelques jours après le feu vert de la Cour d'appel de Nairobi, valorise la cession à environ <strong>2,1 milliards de dollars</strong>.</p>",
      "<p>Concrètement, le gouvernement kényan a cédé <strong>6 milliards d'actions</strong> à 34 shillings l'unité, via une transaction de bloc sur la Bourse de Nairobi (NSE), soit <strong>204,3 milliards de shillings</strong> versés au Trésor. S'y ajoute un dividende exceptionnel de <strong>40,2 milliards de shillings</strong>, adossé aux 20 % que l'État conserve, portant le total encaissé par Nairobi à près de <strong>244,5 milliards de shillings</strong>. Vodacom a par ailleurs acquis, via Vodafone Kenya, une participation effective supplémentaire de 5 % auprès du groupe britannique Vodafone.</p>",
      "<h3>Un feuilleton judiciaire dénoué en dernière minute</h3>",
      "<p>La transaction aura tenu le Kenya en haleine pendant des mois. Gelée depuis mars par la Haute Cour, saisie de recours contestant la constitutionnalité d'une cession menée sans loi de privatisation spécifique, l'opération n'a été débloquée que le <strong>30 juin</strong>, lorsque la Cour d'appel a levé l'injonction. Le règlement-livraison est intervenu dans la foulée, signe de l'empressement des deux parties à sécuriser un accord négocié de longue date.</p>",
      "<p>Safaricom reste cotée à la Bourse de Nairobi et l'État kényan conserve <strong>20 % du capital</strong> ainsi qu'une représentation au conseil d'administration. Mais le centre de gravité de l'entreprise — 47 millions de clients au Kenya, une expansion coûteuse en Éthiopie et surtout <strong>M-Pesa</strong>, la plateforme de paiement mobile la plus utilisée du continent — bascule désormais vers Johannesburg.</p>",
      "<h3>Infrastructures contre souveraineté : le pari de William Ruto</h3>",
      "<p>Pour le président <strong>William Ruto</strong>, cette cession est la pièce maîtresse d'un vaste programme de privatisations censé rapporter environ <strong>2,7 milliards de dollars</strong>, incluant l'introduction en Bourse de Kenya Pipeline Company, qui a levé quelque 106 milliards de shillings. Les produits de ces opérations doivent alimenter un <strong>Fonds national d'infrastructures</strong> destiné à financer routes, énergie et numérique sans alourdir une dette publique déjà critique ni créer de nouveaux impôts — un sujet explosif depuis les manifestations antifiscales de 2024.</p>",
      "<p>« Nous vendons une partie de nos actions, pas notre avenir », a en substance défendu le vice-président Kithure Kindiki, monté au créneau ce week-end avec le chef de l'État pour justifier l'opération face aux critiques. Le gouvernement fait valoir que l'État demeure le deuxième actionnaire de Safaricom et que la vente s'est faite au prix du marché, validée par la justice.</p>",
      "<p>L'opposition et une partie de la société civile y voient au contraire un <strong>bradage d'actifs stratégiques</strong>. Safaricom n'est pas une entreprise comme les autres : elle pèse près de la moitié de la capitalisation de la Bourse de Nairobi, contribue massivement aux recettes fiscales et opère, avec M-Pesa, une infrastructure financière par laquelle transite une part majeure du PIB kényan. Confier son contrôle à un groupe étranger, fût-il africain, pose la question de la souveraineté économique — d'autant que les recours judiciaires ont mis en lumière l'absence de cadre légal clair pour les privatisations.</p>",
      "<h3>Un signal fort pour le capital panafricain</h3>",
      "<p>Au-delà du débat kényan, l'opération illustre une tendance de fond : la consolidation des télécoms africains par des champions du continent. Vodacom, déjà présent dans une dizaine de marchés, met la main sur le premier générateur de cash d'Afrique de l'Est et sur sa croissance éthiopienne, l'un des derniers grands marchés vierges du continent. Pour les investisseurs, le dénouement rapide après la décision de justice envoie un signal de maturité des marchés de capitaux kényans.</p>",
      "<p>Reste l'épreuve de vérité : la capacité du gouvernement Ruto à transformer ces milliards en infrastructures visibles. Si le Fonds national d'infrastructures tarde à produire des résultats, la vente du joyau national pourrait devenir, à l'approche de l'élection de 2027, le symbole d'une promesse non tenue plutôt que celui d'un État réformateur.</p>",
      "<p><em>Sources : Vodacom Group, The EastAfrican, Business Daily Africa, People Daily, Daily Nation, TechCabal/Techpoint Africa, Telecom Review Africa.</em></p>"
    ]
  },

  "google-sommet-cloud-afrique-ia": {
    cat: "cat-economie", catLabel: "Afrique — Économie & Tech",
    img: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1400&q=80&auto=format&fit=crop",
    title: "Google promet 90 milliards de dollars à l'Afrique : le continent tient-il son destin numérique ?",
    excerpt: "À Johannesburg, Google a tenu son tout premier sommet Cloud sur le sol africain et dévoilé cinq initiatives autour de l'IA, chiffrant à 90,6 milliards de dollars et 315 000 emplois l'impact économique attendu d'ici 2030. Derrière les promesses, la même question stratégique : qui contrôlera l'infrastructure de l'intelligence artificielle africaine ?",
    author: "Rédaction AfriPolitique", date: "05 juillet 2026", read: "5 min",
    body: [
      "<p>C'était une première, et le symbole a été soigneusement mis en scène. Le 1er juillet, au Sandton Convention Centre de Johannesburg, Google a tenu son tout premier <strong>sommet Cloud entièrement dédié à l'Afrique</strong> — non plus un événement satellite greffé sur une conférence mondiale, mais un rendez-vous conçu pour le continent. Près de <strong>3 000 dirigeants, développeurs et responsables publics</strong> venus de toute l'Afrique s'y sont pressés. Le président sud-africain Cyril Ramaphosa a ouvert les débats en évoquant « un bond quantique vers l'avenir ». En réponse, le géant américain a aligné les chiffres.</p>",
      "<p>Google a dévoilé <strong>cinq nouvelles initiatives</strong>, empilées sur son engagement existant de <strong>1 milliard de dollars</strong> pour l'Afrique et sur son fonds de <strong>37 millions de dollars</strong> dédié aux compétences en intelligence artificielle. Surtout, l'entreprise a chiffré l'enjeu : sa région Cloud de Johannesburg devrait, selon ses propres projections, contribuer à hauteur de <strong>90,6 milliards de dollars</strong> à la production économique africaine et soutenir près de <strong>315 000 emplois d'ici 2030</strong>. Un ordre de grandeur que plusieurs médias économiques du continent ont relayé sans le vérifier de manière indépendante.</p>",
      "<h3>Une pile d'infrastructures, du câble sous-marin au capital</h3>",
      "<p>Les annonces se lisent comme un édifice cohérent. À la base, le physique : un « Digital Exchange Port » installé dans l'Eastern Cape sud-africain, premier de <strong>quatre hubs de connectivité</strong> prévus sur le continent. Il reliera directement l'Afrique à l'Australie via le câble sous-marin <strong>Umoja</strong> et ouvrira une nouvelle route vers l'Inde — une amélioration discrète mais stratégique pour un continent encore mal desservi en liaisons internationales directes.</p>",
      "<p>Vient ensuite l'accès à la recherche : le premier <strong>laboratoire d'IA appliquée</strong> du continent ouvre à Accra, opéré conjointement par le Google AI Futures Fund et Google Research. Il doit associer fondateurs locaux et chercheurs de Google, avec un accès anticipé aux modèles de pointe, dans l'espoir de faire émerger les premières « licornes IA-natives » africaines ; les candidatures sont ouvertes jusqu'au 31 août. La formation suit sur deux fronts : un partenariat avec l'Akuna Group — la structure du comédien britannique Idris Elba — mobilise plus d'un million de dollars pour l'éducation à l'IA créative, tandis qu'un centre d'innovation numérique doit voir le jour dans un établissement de formation professionnelle de Soweto. Enfin, le capital : à partir du 21 juillet, l'accélérateur de start-up de Google accueillera une cohorte sud-africaine de 15 entreprises, avec financement sans prise de participation, dans le cadre d'un objectif de <strong>50 entreprises soutenues d'ici 2028</strong>.</p>",
      "<h3>Le revers de la médaille</h3>",
      "<p>« Nous construisons sur nos engagements antérieurs en matière d'infrastructures, d'innovation menée par les Africains et de compétences », a résumé James Manyika, vice-président senior de Google chargé de la recherche et de la technologie. Le message est clair : l'entreprise n'entend pas seulement vendre des crédits cloud, mais bâtir la chaîne complète dont un écosystème technologique a besoin — connectivité pour déplacer les données, recherche pour concevoir les produits, formation pour produire les talents, capital pour financer les fondateurs.</p>",
      "<p>C'est précisément cette intégration verticale qui nourrit la vigilance des observateurs. Câbles sous-marins et régions cloud sont des infrastructures coûteuses et « collantes » : une fois qu'une entreprise africaine bâtit sur la région de Johannesburg, en changer devient onéreux. Le laboratoire d'Accra formera des start-up sur les modèles de Google, pas sur ceux de ses concurrents. Les programmes de compétences de Soweto produiront des travailleurs rompus aux outils maison. En clair, l'investissement, bien réel et répondant à des besoins criants — l'Afrique concentre 18 % de la population mondiale mais moins de 1 % de la capacité mondiale des centres de données —, se double d'un pari de plateforme sur le long terme.</p>",
      "<h3>La souveraineté, question politique de fond</h3>",
      "<p>Le débat dépasse la seule Afrique du Sud. À l'échelle du continent, les stratégies nationales du Ghana, du Nigeria, du Kenya et de l'Égypte insistent toutes sur la réduction de la dépendance aux fournisseurs étrangers. Or, une enquête du média <em>Rest of World</em> soulignait fin juin que les plans d'IA africains restent tributaires d'une poignée de mastodontes — Google, Microsoft, Nvidia et Meta —, qui fournissent aussi bien la puissance de calcul que les modèles et les capitaux. Diversifier les partenaires ne suffit pas à garantir la souveraineté si la brique fondamentale reste importée.</p>",
      "<p>Les Africains cherchent malgré tout à peser davantage dans la gouvernance mondiale de la technologie. Le 2 juillet, au lendemain du sommet de Johannesburg, le président rwandais Paul Kagame a été nommé <strong>coprésident de la nouvelle « AI for Good Global Commission »</strong>, aux côtés du patron de Salesforce Marc Benioff — une manière d'installer une voix africaine dans les instances qui façonneront les règles du jeu.</p>",
      "<p>Reste la question que le sommet de Johannesburg pose sans y répondre : à quelles conditions ? L'Afrique ne deviendra pas autosuffisante en intelligence artificielle, et aucun gouvernement ne s'en fixe l'objectif. Mais entre l'urgence de combler les retards de connectivité et de compétences, et le risque de verrouiller pour une décennie sa dépendance à un opérateur unique, les dirigeants africains jouent une partie serrée. Google parie que « celui qui bâtit aujourd'hui les fondations de l'IA africaine en détiendra la relation pour les dix prochaines années ». Au vu des montants sur la table, c'est un pari qu'il faudra suivre de près.</p>"
    ]
  },


  "souverainete-ia-data-center-kenya": {
    cat: "cat-economie", catLabel: "Afrique — Économie & Tech",
    img: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1400&q=80&auto=format&fit=crop",
    title: "Le data center à 1 milliard de dollars qui révèle la dépendance africaine à l'IA",
    excerpt: "Deux ans après l'annonce d'un investissement d'un milliard de dollars de Microsoft et G42, le data center « vert » du Kenya est à l'arrêt, faute d'électricité. Derrière ce coup de frein, la question la plus stratégique du moment : qui contrôlera l'infrastructure de l'intelligence artificielle africaine, et à quel prix ?",
    author: "Rédaction AfriPolitique", date: "30 juin 2026", read: "5 min",
    body: [
      "<p>En signant, il y a deux ans, une lettre d'intention pour un investissement de <strong>1 milliard de dollars</strong>, Microsoft et la société émiratie G42 promettaient au Kenya le plus grand data center « vert » d'Afrique de l'Est : <strong>100 mégawatts</strong> de capacité initiale, extensible à <strong>1 gigawatt</strong>, alimenté par la géothermie d'Olkaria. Deux ans plus tard, le projet est à l'arrêt. Le président William Ruto a reconnu, ces derniers jours à Nairobi, que le réseau électrique kényan ne peut tout simplement pas absorber une installation de cette ampleur. Derrière ce coup de frein se cache la question la plus stratégique du moment pour le continent : qui contrôlera l'infrastructure de l'intelligence artificielle africaine, et à quel prix ?</p>",
      "<p>La question a été posée frontalement en avril, à Tanger, où les ministres de l'Union africaine se sont réunis pour débattre d'IA. Pendant des années, les discussions portaient sur l'adoption : comment les États, les entreprises et les services publics pouvaient utiliser la technologie. Désormais, l'attention se déplace vers la propriété, la gouvernance et les conditions dans lesquelles ces systèmes sont développés. Le Ghana, dans sa stratégie nationale lancée en avril, qualifie l'IA de « capacité souveraine ». Le Nigeria, le Kenya et l'Égypte ont eux aussi publié des stratégies insistant sur la nécessité de réduire la dépendance aux fournisseurs étrangers. Quarante-neuf pays et l'Union africaine ont endossé la Déclaration africaine sur l'intelligence artificielle.</p>",
      "<h3>Moins de 1 % de la capacité mondiale</h3>",
      "<p>Le rapport de force est d'abord infrastructurel. L'Afrique abrite environ <strong>18 % de la population mondiale</strong>, mais représente <strong>moins de 1 %</strong> de la capacité mondiale des centres de données, selon les estimations du secteur. Une étude du cabinet McKinsey relève que les cinq plus grands marchés africains de data centers réunis pèsent moins que la seule France. Partout sur le continent, une fourniture électrique défaillante reste le principal frein à l'expansion. C'est précisément ce mur qu'a heurté le projet kényan : à pleine capacité, l'installation consommerait davantage d'électricité que n'en produisent aujourd'hui plusieurs pays africains.</p>",
      "<p>Le cas d'Olkaria est emblématique des arbitrages en jeu. Le site dispose pourtant d'atouts rares : la Kenya Electricity Generating Company y exploite plusieurs centrales géothermiques d'une capacité installée supérieure à <strong>700 MW</strong>, une énergie propre et constante, idéale pour des serveurs. Mais l'appétit énergétique de l'IA est tel qu'il met en concurrence directe les data centers et les foyers, les industries et les exportations. Attirer l'investissement étranger tout en pesant les besoins énergétiques, les coûts de financement et la dépendance stratégique de long terme : tel est le dilemme que résume, à lui seul, le dossier kényan.</p>",
      "<h3>Un enjeu de souveraineté, pas seulement de technologie</h3>",
      "<p>L'enjeu déborde en effet la seule question technique. Les centres de données sont aussi de gros consommateurs d'eau, et leur implantation fait surgir des tensions socio-économiques locales. Surtout, ils déterminent où seront stockées et traitées les données sensibles des citoyens et des États africains. « Ces négociations ne doivent pas se mener au seul niveau des élites pour être ensuite imposées aux citoyens », avertit Joseph Asunka, directeur général d'Afrobarometer. « Si les citoyens ne font pas confiance à l'action de leur gouvernement dans ce domaine, cela crée un déficit de confiance aux conséquences négatives pour l'adoption de la fintech, du commerce électronique et des services publics numériques. »</p>",
      "<p>La fragmentation même de l'industrie mondiale de l'IA pourrait toutefois jouer en faveur du continent. « Les États africains disposeront d'une marge de manœuvre accrue sur l'IA et l'infrastructure de données, précisément en raison du caractère disputé et fragmenté de cette industrie entre les leaders mondiaux », estime Priyal Singh, analyste géopolitique chez Signal Risk. Les grandes entreprises technologiques devront, selon lui, « s'incliner devant les préoccupations locales bien plus souvent qu'elles ne s'y attendraient ». Les tensions réglementaires autour de l'expansion de Starlink dans plusieurs pays africains en sont déjà une illustration.</p>",
      "<h3>Diversifier sans changer de dépendance</h3>",
      "<p>Reste que diversifier ses partenaires ne suffit pas à garantir la souveraineté. « Qu'il s'agisse de s'éloigner des entreprises technologiques occidentales ou de se tourner vers des acteurs chinois, cela relève généralement d'un calcul coûts-bénéfices », souligne Sanusha Naidu, chercheuse à l'Institute for Global Dialogue. La vraie question, pour les gouvernements, est de savoir ce que ces partenariats rapportent réellement aux populations : emplois, transferts de compétences, retombées concrètes. Elle établit un parallèle avec l'industrie textile des années 1990, où l'investissement arrivait au prix de lourdes subventions du pays d'accueil. « Avec les data centers, c'est bien plus intense », prévient-elle.</p>",
      "<p>Des initiatives existent pour bâtir des capacités locales, à l'image du programme timbuktoo du PNUD, qui soutient l'innovation et l'écosystème technologique africain. Elles restent modestes au regard des montants mondiaux en jeu. L'Afrique ne deviendra pas autosuffisante en intelligence artificielle, et ce n'est l'objectif d'aucun gouvernement : le continent demeurera intégré aux chaînes mondiales de la technologie. La question n'est donc pas de savoir si l'Afrique utilisera l'IA, mais à quelles conditions. Le data center suspendu d'Olkaria rappelle que ces conditions — énergie, données, financement — se négocient maintenant. Et que les décisions prises aujourd'hui dessineront qui, demain, contrôlera les technologies qui façonnent déjà les économies, les services publics et la vie quotidienne du continent.</p>"
    ]
  },
