...
const ARTICLES = {
  ...
  "ia-infrastructure-souverainete-2026": {
    ...
    title: "Course aux centres de données : qui contrôlera l'infrastructure de l'IA africaine ?",
    excerpt: "Le marché africain des centres de données filera vers 8,76 milliards de dollars d'ici 2031. Mais derrière les milliards promis par Microsoft, G42 ou les fonds souverains, une question politique s'impose : à qui appartiendra réellement le cerveau numérique du continent ?",
    author: "Rédaction AfriPolitique", date: "26 juin 2026", read: "5 min",
    body: [
      "<p>C'est la question qui agite désormais les chancelleries autant que les conseils d'administration. Alors que les annonces d'investissements dans l'intelligence artificielle se multiplient sur le continent, une interrogation politique de fond domine ce 26 juin : à mesure que les géants étrangers financent serveurs, centres de données et grands modèles de langage en Afrique, <strong>quel contrôle les États africains conserveront-ils sur l'infrastructure dont dépendent ces technologies ?</strong> Posée cette semaine par plusieurs analystes, dont le réseau Al Jazeera, la question résume la nouvelle bataille de souveraineté du continent.</p>",
      "<p>Les chiffres expliquent l'enjeu. Selon une étude du cabinet Arizton publiée le 24 juin, les investissements dans le marché africain des centres de données devraient atteindre <strong>8,76 milliards de dollars d'ici 2031</strong>, avec une croissance annuelle moyenne de 15,76 %. L'Afrique du Sud, le Kenya, le Nigeria et l'Égypte s'imposent comme les quatre pôles stratégiques, portés par leurs écosystèmes de connectivité, leurs économies numériques en expansion et une demande croissante de services cloud.</p>",
      "<h3>Des milliards venus de l'extérieur</h3>",
      "<p>Le mouvement est largement alimenté par des capitaux étrangers. Au Kenya, Microsoft et la société technologique émiratie G42 ont scellé un programme d'<strong>un milliard de dollars</strong> comprenant un centre de données « vert » destiné à la région cloud d'Azure pour l'Afrique de l'Est, ainsi que le développement de grands modèles de langage en swahili et en anglais. Un projet emblématique, mais dont le président kényan William Ruto lui-même a souligné l'appétit énergétique colossal.</p>",
      "<p>Le Nigeria, pays le plus peuplé du continent, s'apprête de son côté à mettre en service ses premiers centres de données dédiés à l'IA, soutenus par près d'un milliard de dollars d'investissements de géants technologiques mondiaux et régionaux. L'un des projets, doté de <strong>250 millions de dollars</strong> et adossé à la Nigeria Sovereign Investment Authority, a été conçu pour absorber les densités de puissance extrêmes et les besoins de refroidissement propres aux charges de travail de l'IA. Reste un obstacle de taille : les déficits chroniques d'électricité qui contraignent encore les ambitions d'Abuja.</p>",
      "<h3>La réponse continentale : mobiliser et encadrer</h3>",
      "<p>Face à cette ruée, l'Afrique tente d'organiser sa propre stratégie. Quarante-neuf pays, aux côtés de l'Union africaine, ont endorsé la <em>Déclaration africaine sur l'intelligence artificielle</em>, qui appelle à investir davantage dans les infrastructures, les talents et l'innovation du continent, et à mettre en place des mécanismes de financement coordonnés. En avril, les ministres de l'UA réunis à Tanger, au Maroc, ont consacré l'essentiel de leurs travaux à cette question.</p>",
      "<p>Sur le terrain financier, l'initiative la plus ambitieuse reste l'<strong>AI 10 Billion Initiative</strong>, lancée par la Banque africaine de développement (BAD) et le Programme des Nations unies pour le développement (PNUD) lors du Nairobi AI Forum des 9 et 10 février 2026. Le partenariat vise à mobiliser jusqu'à <strong>10 milliards de dollars d'ici 2035</strong> pour bâtir les fondations de l'IA africaine — données, puissance de calcul, compétences, gouvernance et capital — avec l'objectif de créer jusqu'à <strong>40 millions d'emplois</strong> et d'ajouter, selon la BAD, près de <strong>1 000 milliards de dollars au PIB du continent</strong> à l'horizon 2035.</p>",
      "<p>« La Banque met à profit son avantage comparatif pour que l'Afrique ne soit pas laissée pour compte à l'ère de l'IA », a résumé Nicholas Williams, responsable des opérations TIC de la BAD, qui annonce une tournée de dix mois auprès des gouvernements et du secteur privé pour nouer de nouveaux partenariats.</p>",
      "<h3>Souveraineté numérique : le vrai test politique</h3>",
      "<p>Pour de nombreux gouvernements — du Nigeria au Kenya, en passant par l'Égypte et le Ghana, qui ont tous adopté des stratégies nationales d'IA —, l'enjeu dépasse la croissance. Il s'agit de réduire la dépendance vis-à-vis des fournisseurs technologiques étrangers et de garder la main sur des données stratégiques. Quand un centre de données est construit, financé et opéré par une multinationale, qui en fixe les règles d'accès ? Qui détient les modèles entraînés sur des données africaines ? Et qui décide de leur usage en cas de tension géopolitique ?</p>",
      "<p>Le continent avance ainsi sur une ligne de crête. D'un côté, l'urgence de capter des investissements massifs pour ne pas rater la révolution de l'IA ; de l'autre, la crainte d'une nouvelle forme de dépendance, où l'Afrique fournirait les données et l'énergie sans maîtriser le cerveau numérique qui les exploite. Entre la promesse d'un bond économique à 1 000 milliards de dollars et le risque d'une souveraineté hypothéquée, les choix faits en 2026 dessineront, pour une génération, la place de l'Afrique dans l'économie mondiale de l'intelligence artificielle.</p>"
    ]
  },
