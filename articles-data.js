...
const ARTICLES = {
  ...
  "souverainete-ia-afrique": {
    ...
    title: "Souveraineté numérique : l'Afrique veut maîtriser son intelligence artificielle, mais l'infrastructure reste aux mains des géants américains",
    excerpt: "Le continent abrite 18 % de l'humanité mais moins de 1 % des capacités mondiales de centres de données. Alors qu'un fonds de 60 milliards de dollars promet de combler le retard, les grandes économies africaines découvrent que le chemin vers la « souveraineté » de l'IA passe encore par les serveurs de Google, Microsoft et Nvidia.",
    author: "Rédaction AfriPolitique", date: "28 juin 2026", read: "5 min",
    body: [
      "<p>C'est un paradoxe que les dirigeants africains assument de plus en plus ouvertement : pour conquérir leur indépendance technologique, ils doivent d'abord s'en remettre aux géants américains du numérique. Quatre des plus grandes économies technologiques du continent — le Nigeria, l'Égypte, le Kenya et l'Afrique du Sud — ont chacune publié, depuis le début de 2025, des stratégies nationales d'intelligence artificielle qui partagent un même constat : leur dépendance vis-à-vis de Google, Microsoft, Nvidia et Meta est devenue un enjeu de sécurité nationale.</p>",
      "<p>La question de fond a été remise sur le devant de la scène fin juin par une enquête d'Al Jazeera : <em>qui contrôlera l'infrastructure de l'IA africaine, et à quel prix ?</em> Derrière l'effervescence des annonces de centres de données et de partenariats cloud se cache un rapport de force déséquilibré, qui rappelle d'autres époques de la relation entre le continent et le reste du monde.</p>",
      "<h3>Un retard structurel vertigineux</h3>",
      "<p>Les chiffres donnent la mesure de l'écart à combler. L'Afrique représente <strong>18 % de la population mondiale</strong>, mais concentre <strong>moins de 1 % des capacités mondiales de centres de données</strong>, selon le Forum économique mondial. Plus frappant encore : les cinq principaux marchés africains réunis disposent d'une capacité inférieure à celle dont disposait la seule France en 2024, calcule le cabinet McKinsey. Or les modèles d'intelligence artificielle contemporains sont gourmands en puissance de calcul, en énergie et en données — précisément ce qui manque le plus au continent.</p>",
      "<p>Cette pénurie place les États africains en position de demandeurs. Faute d'infrastructures locales, beaucoup se résignent à des montages « segmentés », où les données sont stockées sur le sol national mais traitées à l'étranger, sur des serveurs appartenant à des tiers. « Il ne s'agit pas seulement d'avoir le contrôle, mais d'avoir un contrôle réel », résume Tay PeiChin, du Tony Blair Institute, qui met en garde contre le risque de dépendance technologique à un fournisseur unique.</p>",
      "<h3>60 milliards de dollars… et 12 000 puces Nvidia</h3>",
      "<p>La réponse africaine s'organise. En juillet 2024, l'Union africaine a adopté une <strong>Stratégie continentale pour l'intelligence artificielle</strong>. En novembre 2025, l'organisation Smart Africa a installé un <strong>Conseil africain de l'IA</strong> chargé de mutualiser les ressources. Surtout, un <strong>Fonds africain pour l'IA doté de 60 milliards de dollars</strong>, annoncé au sommet de Kigali en avril 2025, doit financer infrastructures, talents et start-up.</p>",
      "<p>Mais le détail de ce fonds illustre la contradiction. Parmi ses cibles figure l'acquisition de <strong>12 000 processeurs graphiques Nvidia</strong> destinés à équiper des centres dans les quatre grandes économies et au Maroc. Autrement dit, le véhicule censé incarner la souveraineté africaine repose, dans sa mécanique même, sur la chaîne d'approvisionnement des mêmes géants américains. La « souveraineté » se négocie donc moins comme une indépendance totale que comme l'obtention de meilleures conditions à l'intérieur d'un système que l'on ne quitte pas.</p>",
      "<h3>Des projets phares déjà tributaires de l'Occident</h3>",
      "<p>Les réalisations les plus emblématiques confirment cette logique. L'entreprise Cassava, fondée par le Zimbabwéen Strive Masiyiwa, a lancé en mars la première « usine à IA » du continent, en Afrique du Sud, avec la technologie de Nvidia ; son projet Mufungi prévoit d'investir <strong>720 millions de dollars</strong> et de déployer <strong>15 000 puces Nvidia H100</strong>. Au Kenya, le fournisseur iXAfrica s'appuie sur Oracle pour bâtir la première région de cloud public du pays.</p>",
      "<p>Tous les chantiers ne tiennent pas leurs promesses pour autant. Le centre de données d'un milliard de dollars que Microsoft devait construire avec G42 au Kenya s'est <strong>enlisé</strong>, le gouvernement ayant refusé de s'engager sur les achats de capacité de calcul exigés par les deux partenaires, révélait Bloomberg en mai. Le signe que les États commencent à poser leurs conditions — au risque de retarder les investissements qu'ils appellent par ailleurs de leurs vœux.</p>",
      "<h3>Reprendre la main sur les données</h3>",
      "<p>Sur le terrain de la donnée, des lignes bougent. Le Ghana, le Nigeria et la Zambie ont récemment rejeté des accords de partage de données de santé adossés à des intérêts américains, qui auraient transféré hors de leurs frontières les informations de leurs citoyens. Plusieurs experts plaident pour une approche régionale : aucun pays n'a, seul, le volume d'activité suffisant pour justifier la construction d'infrastructures de pointe.</p>",
      "<p>Mais la coopération bute sur un obstacle politique. « Le coût de la coordination est très élevé, et les pays ont toujours intérêt à négocier bilatéralement », observe Hilda Barasa, du Tony Blair Institute. La concurrence que se livrent les capitales africaines pour attirer les investissements étrangers fragilise, de fait, l'idée d'un marché numérique continental uni.</p>",
      "<p>Reste une question que ces partenariats posent en creux, et que résume une chercheuse du Global Center on AI Governance à propos d'accords comme celui signé entre Anthropic et le Rwanda : former des fonctionnaires et améliorer les services publics est utile, mais cela revient aussi à faire absorber par l'Afrique le coût d'adoption de technologies conçues ailleurs. La souveraineté numérique africaine ne se jouera donc pas seulement sur le nombre de centres de données inaugurés, mais sur la capacité du continent à fixer les termes — juridiques, économiques et politiques — de sa dépendance.</p>"
    ]
  },
