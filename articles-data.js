...
const ARTICLES = {
  "nigeria-note-sp-dangote": {
    cat: "cat-economie", catLabel: "Afrique — Économie & Finance",
    img: "https://images.unsplash.com/photo-1466611653911-95081537e5b7?w=1400&q=80&auto=format&fit=crop",
    title: "Nigeria : portée par la raffinerie Dangote, la note souveraine remonte pour la première fois en quatorze ans",
    excerpt: "L'agence S&P a relevé la note souveraine du Nigeria de « B- » à « B », sa première amélioration depuis 2012, en citant explicitement la raffinerie Dangote. Devenu exportateur net de carburants, le géant ouest-africain reconstitue ses réserves et transforme une dépendance structurelle en levier de souveraineté économique.",
    author: "Rédaction AfriPolitique", date: "22 juin 2026", read: "5 min",
    body: [
      "<p>C'est une bascule que peu d'observateurs anticipaient il y a trois ans. L'agence de notation <strong>S&amp;P Global Ratings</strong> a relevé la note souveraine en devises du Nigeria de « B- » à « B », assortie d'une perspective stable. Il s'agit de la <strong>première amélioration de la note nigériane depuis 2012</strong> — soit quatorze ans — et l'agence a pris soin d'en nommer la cause principale : la montée en puissance de la raffinerie d'Aliko Dangote, un complexe industriel de 20 milliards de dollars devenu le symbole d'une stratégie d'industrialisation longtemps restée à l'état de promesse.</p>",
      "<p>Le geste de S&amp;P n'est pas isolé. Il prolonge une série d'actions positives de Fitch et de Moody's au cours de l'année 2025, confirmant un alignement rare des trois grandes agences sur la trajectoire de la première puissance démographique d'Afrique. Pour Abuja, le signal est autant économique que politique : il valide, aux yeux des marchés internationaux, les réformes douloureuses engagées depuis 2023.</p>",
      "<h3>De premier importateur à exportateur net</h3>",
      "<p>Pendant des décennies, le paradoxe nigérian a frappé les esprits : premier producteur de pétrole brut du continent, le pays importait la quasi-totalité de ses carburants raffinés, faute de raffineries fonctionnelles. Cette dépendance lui coûtait <strong>près de 10 milliards de dollars par an</strong> en devises, l'un des principaux points de fragilité de sa balance des paiements.</p>",
      "<p>La raffinerie Dangote, dotée d'une capacité nominale de <strong>650 000 barils par jour</strong>, a inversé l'équation. Le Nigeria est passé du statut d'importateur net à celui d'exportateur de produits pétroliers raffinés. Sur les neuf premiers mois de 2025, ces exportations ont généré <strong>4,2 milliards de dollars</strong> d'entrées de devises ; les projections les portent à environ <strong>10,2 milliards de dollars en 2026</strong>. Autant de pression en moins sur le naira et sur les comptes extérieurs.</p>",
      "<h3>Réserves reconstituées, compte courant excédentaire</h3>",
      "<p>Les effets se lisent dans les agrégats macroéconomiques. Les <strong>réserves de change</strong> ont grimpé d'environ 33 milliards de dollars en 2023 à près de 50 milliards début 2026, certains relevés évoquant un plus haut de plusieurs années. S&amp;P projette un <strong>excédent du compte courant de 5,8 % du PIB en 2026</strong>, contre 4,8 % en 2025 ; des analystes locaux chiffrent le surplus extérieur autour de 17,7 milliards de dollars. Une respiration précieuse pour une banque centrale qui, jusqu'en 2023, brûlait ses devises pour soutenir une monnaie surévaluée.</p>",
      "<h3>Le pari risqué des réformes Tinubu</h3>",
      "<p>Derrière les chiffres, il y a un choix politique. Dès son arrivée au pouvoir en 2023, le président Bola Tinubu a supprimé la subvention sur les carburants et unifié les multiples taux de change du naira — deux décisions saluées par les bailleurs mais brutales pour les ménages. L'inflation a flambé, le coût de la vie a bondi, et la grogne sociale a nourri plusieurs vagues de contestation. La remontée de la note souveraine offre aujourd'hui à l'exécutif un argument de poids : la médecine de cheval commencerait à produire ses effets.</p>",
      "<p>Le pari reste néanmoins fragile. La sécurité se dégrade dans plusieurs régions, la pauvreté demeure massive et les bénéfices de la reprise tardent à atteindre la rue. Une amélioration de notation réduit le coût de la dette et rouvre l'accès aux marchés, mais elle ne nourrit pas mécaniquement une population de plus de 220 millions d'habitants.</p>",
      "<h3>Un signal pour tout le continent</h3>",
      "<p>Au-delà du cas nigérian, l'épisode résonne comme une démonstration. Alors que l'Afrique cherche à mobiliser ses financements de développement dans un monde fragmenté — thème de l'édition 2026 des Perspectives économiques africaines —, le Nigeria avance une réponse concrète : <strong>l'industrialisation et la transformation locale</strong> comme antidote à la dépendance aux importations et à la volatilité des matières premières. Si la trajectoire se confirme, elle pourrait inspirer d'autres économies du continent tentées de troquer la rente brute contre la valeur ajoutée. Reste à transformer l'embellie financière en amélioration tangible du quotidien — la véritable épreuve de vérité des réformes.</p>"
    ]
  },
